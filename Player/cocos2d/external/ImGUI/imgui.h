...
namespace ImGui
{
    ...
    IMGUI_API bool          ImageButton(const ImVec2& size, const char* spriteFrameName, bool selected = false, int frame_padding = -1, const ImVec4& bg_col = ImVec4(0,0,0,0), const ImVec4& tint_col = ImVec4(1,1,1,1));    // <0 frame_padding uses default frame padding settings. 0 for no padding
	...
	IMGUI_API void          ForcedClosePopup();                                                 // forced the poupu to close.
#endif
